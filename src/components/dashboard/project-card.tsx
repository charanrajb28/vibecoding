...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div className="p-[1px] bg-gradient-to-r from-transparent via-transparent to-primary rounded-lg transition-all duration-300 ease-in hover:[background-position:0_0] bg-[length:200%_100%] bg-[position:100%_0]">
        <Card className="transition-all duration-300 ease-in hover:shadow-xl hover:-translate-y-1 h-full flex flex-col">
